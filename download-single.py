...
parser = argparse.ArgumentParser(description='Download a specified class from open images dataset')
parser.add_argument("-o", "--object", required=True, help="Specify the name of the object to download")
parser.add_argument("-r", "--runmode", required=True, help="Specify to download ""train"" or ""test""dataset")

args = vars(parser.parse_args())
runMode = args.runmode
classes = []
classes.append(args.object) 
